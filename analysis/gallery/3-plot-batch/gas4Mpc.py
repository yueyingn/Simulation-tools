...
outprefix = '/home1/06431/yueyingn/scratch/asterix/plot-batch/gas-4Mpc/CUT-'+snap
ofilename = outprefix + '-4MPCh'
...
ax = axes
img = color.CoolWarm(color.NL(channels[1], range=(3,8)), color.NL(channels[0], range=(vmin,vmax)))
...
ax.text(Lb*0.5-Lb*0.08,yst-Lb*0.03,'4 cMpc/h',dict(color='white'),size=20)
ax.text(Lb*0.02,Lb*0.09,info,dict(color='white'),size=18)
# ax.scatter(0.5*Lb,0.5*Lb,s=150,c='white',marker='x')
