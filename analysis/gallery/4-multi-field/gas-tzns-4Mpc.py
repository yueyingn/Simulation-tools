...
# temperature
channels = painter.paint(gasdev, gassl/resolution, [gasm, gasm*gastem], (imsize, imsize), np=8)
channels[1] /= channels[0]
ofile_dir = prefix.replace('2-cut-more','3-paint/temp-channel-4Mpc/')
...
# metal
channels = painter.paint(gasdev, gassl/resolution, [gasm, gasm*gasz], (imsize, imsize), np=8)
channels[1] /= channels[0]
ofile_dir = prefix.replace('2-cut-more','3-paint/metal-channel-4Mpc/')
if not os.path.exists(ofile_dir):
    os.makedirs(ofile_dir)
ofilename = ofile_dir + fname
np.save(ofilename,channels)
...
# sfr
channels = painter.paint(gasdev, gassl/resolution, [gasm, gasm*gassfr], (imsize, imsize), np=8)
channels[1] /= channels[0]
ofile_dir = prefix.replace('2-cut-more','3-paint/sfr-channel-4Mpc/')
if not os.path.exists(ofile_dir):
    os.makedirs(ofile_dir)
ofilename = ofile_dir + fname
np.save(ofilename,channels)
...
# nh2
channels = painter.paint(gasdev, gassl/resolution, [gasm, gasm*gasnf], (imsize, imsize), np=8)
channels[1] /= channels[0]
ofile_dir = prefix.replace('2-cut-more','3-paint/nh2-channel-4Mpc/')
if not os.path.exists(ofile_dir):
    os.makedirs(ofile_dir)
ofilename = ofile_dir + fname
np.save(ofilename,channels)
